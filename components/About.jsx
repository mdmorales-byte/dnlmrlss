      ...
      <div className="mx-auto max-w-[1280px] px-6 md:px-10">
        <div className="grid gap-12 md:grid-cols-[0.9fr_1.1fr] md:items-center">
          ...
          <div className="flex flex-col justify-center">
            ...
            <h2 className="max-w-[620px] text-4xl font-semibold tracking-[-0.055em] text-paper md:text-[4rem] md:leading-[0.95]">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-line/60 bg-[#0d1a29] p-4">
                <p className="font-mono text-xs text-signal2">Location</p>
                <p className="mt-2 text-[1.05rem] text-paper">{profile.location}</p>
              </div>
              <div className="rounded-xl border border-line/60 bg-[#0d1a29] p-4">
                <p className="font-mono text-xs text-signal2">Education</p>
                <p className="mt-2 text-[1.05rem] text-paper">{profile.school}</p>
              </div>
            </div>

            <div className="mt-8">
              <a href="#contact" className="inline-flex rounded-full bg-signal px-6 py-3 text-[15px] font-medium text-ink transition hover:bg-signal/90">
                Start a project
              </a>
            </div>
          </div>
